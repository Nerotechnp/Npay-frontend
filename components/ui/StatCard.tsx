...
export function StatCard({
  ...
  return (
    <div className="rounded-2xl border border-line bg-white p-4 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-moss/30 hover:shadow-md">
